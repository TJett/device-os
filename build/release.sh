...
usage: release.sh [--output-directory=<binary_output_directory>]
                  ...
                  |b5som|esomx|p2|msom|electron2|sulu>...
                  | --platform-id=<12|13|15|22|23|25|26|32|35|37|38>)
                  [--debug] [--help] [--tests]
...
# GEN3
if [ $PLATFORM_ID -eq 12 ] || [ $PLATFORM_ID -eq 13 ] || [ $PLATFORM_ID -eq 15 ] || [ $PLATFORM_ID -eq 22 ] || [ $PLATFORM_ID -eq 23 ] || [ $PLATFORM_ID -eq 25 ] || [ $PLATFORM_ID -eq 26 ] || [ $PLATFORM_ID -eq 28 ] || [ $PLATFORM_ID -eq 32 ] || [ $PLATFORM_ID -eq 35 ] || [ $PLATFORM_ID -eq 37 ] || [ $PLATFORM_ID -eq 38 ]; then
    # Configure
    if [ $DEBUG = true ]; then
        cd ../main
        MODULAR="n"
